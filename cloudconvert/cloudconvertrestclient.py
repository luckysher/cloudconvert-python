...
def default_client():
    ...
    if __client__ is None:
        try:
            ...
            raise exceptions.MissingConfig("Required CLOUD_CONVERT_API_KEY \n Refer https://cloudconvert.com/api/v2#overview")

        # Get default API mode
        sandbox = True if os.environ.get("API_MODE", "sandbox") == 'sandbox' else False

        __client__ = CloudConvertRestClient({}, sandbox=sandbox, token=API_KEY)
